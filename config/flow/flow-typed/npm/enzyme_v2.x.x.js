declare module 'enzyme' {
  ...
  declare class ShallowWrapper<ShallowWrapper> extends Wrapper<any> {
    shallow(option>: {context?: Object}): ShallowWrapper;
  }
  declare class CheerioWrapper<CheerioWrapper> extends Wrapper<any> {}
  declare function shallow(node: React$Element<any>, option?: {context?: Object }): ShallowWrapper<any>;
  declare function mount(node: React$Element<any>, option?: {context?: Object, attachTo?: HTMLElement, childContextTypes?: Object }): ReactWrapper<any>;
